...
void Shell::help(std::stringstream &command, Manager &manager, IOBuffer &new_data, IOBuffer &data_to_delete) {
  ...
  /*cout << "stats - Prints statistics informations" << endl;
  ...
  std::cout << "stats <type_of_statistic> [<type_of_data>]"
               "\n\tPrints the required statistic.\n"
               "\tPossible statistic to get:\n"
               "\tnumber, most, average_age, best_post, worse_post\n"
               "\tIn case of \"stats number\" and \"stats most\", the type of data need to be inserted.\n"
               "\t\"stats number\" possible data: \n"
               "\taccounts, user, groups, companies, friends, relatives, employees, subsidiaries, members, born_after\n"
               "\t\"stats most\" possible data: \n"
               "\temploying_company, employing_partnership, user_friends, user_acquaintances, liked_post, disliked_post,\n\tliked_account, disliked_account\n"
            << std::endl;
}
  ...
  if (what_to_get == "info") {
    ...
    if (account_type == 0) {
      ...
      std::cout << "Name: " << user.getName() << "\n"
                ...
                << "Subscription Date: " << user.getSubscription() << "\n"
                << "Type of Account: User" << std::endl;
      ...
      std::cout << "Name: " << group.getName() << "\n"
                ...
                << "Birth Date: " << group.getSubscription() << "\n"
                << "Type of Account: Group" << std::endl;
    }
      //Get info - company
      ...
      std::cout << "Name: " << company.getName() << "\n"
                ...
                << "Birth Date: " << company.getSubscription() << "\n"
                << "Type of Account: Company" << std::endl;
    }
  }
    //Get relation
